...
class ZionPageBuilderAdmin
{
	...
	public static function get_buttons_html(){
		...
		echo '<div class="zn_pb_buttons">';
			...
			echo '<div data-toolbar-item="true" type="button" name="publish" id="zn_enable_pb" data-postid="'.$post->ID.'" data-active-text="'.$disable_text.'" data-inactive-text="'.$enable_text.'" class="button button-zn_save button-large"><span class="spinner"></span> <span class="zn_bt_text">'.$active_text.'</span></div>';
			echo '<a data-toolbar-item="true" href="'.$preview_link.'" id="zn_edit_page" class="button button-primary button-large zn_pb_button" '.$button_css.'>Edit this page with pagebuilder</a>';
		echo '</div>';
	}
