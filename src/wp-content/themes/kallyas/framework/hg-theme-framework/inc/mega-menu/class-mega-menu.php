...
class ZnMegaMenu{
	...
	static public function getSmartAreas(){
...
class ZnWalkerNavMenu extends Walker {
	...
	function __construct(){
		...
		add_filter( 'zn_hg_mega_menu_inner_wrapper_start', array( get_class(), 'megaMenuContainerWrapperStart' ), 10, 3 );
		//@params: $endTag = ''
		add_filter( 'zn_hg_mega_menu_inner_wrapper_end', array( get_class(), 'megaMenuContainerWrapperEnd' ), 10, 1 );
	}
