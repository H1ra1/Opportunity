...
<?php if (have_comments()) : ?>
    ...
    <h3 id="comments" class="kl-comments-title" <?php echo WpkPageHelper::zn_schema_markup('subtitle'); ?>><?php comments_number( __( 'No Comments', 'zn_framework'), __( '1 Comment', 'zn_framework' ), __( '% Comments', 'zn_framework' ) ); ?> <?php _e( 'to &#8220;', 'zn_framework' ) ?> <?php the_title(); ?>&#8221;</h3>
