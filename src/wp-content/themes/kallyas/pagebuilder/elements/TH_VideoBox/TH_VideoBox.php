	...
	function options()
	{
		...
		$options = array(
			...
			'help' => znpb_get_helptab( array(
				'video'   => sprintf( '%s', esc_url('https://my.hogash.com/video_category/kallyas-wordpress-theme/#flIrJ1rcYlo') ),
				'docs'    => sprintf( '%s', esc_url('https://my.hogash.com/documentation/video-box/') ),
				'copy'    => $uid,
				'general' => true,
			)),
