...
define('EDD_UWA_AUCTION_PRO_ITEM_NAME', 'Ultimate Woo Auction Pro - Business - Lifetime'); // you should use your own CONSTANT name, and be sure to replace it throughout this file
...
$edd_updater = new EDD_SL_Plugin_Updater(EDD_UWA_AUCTION_PRO_STORE_URL, __FILE__, array(
    'version' => '2.3.7', // current version number
 ...
 *************************************/
	...
	if ( ! class_exists( 'Ultimate_WooCommerce_Auction_Pro' ) ) {
		...
		if( !defined( 'UW_AUCTION_PRO_VERSION' ) ) {
			define( 'UW_AUCTION_PRO_VERSION', '2.3.7' ); /* plugin version */
		}
		...
		class Ultimate_WooCommerce_Auction_Pro { 	
			...
			public function init() {
				...
				*/		
				...
				require_once ( UW_AUCTION_PRO_DIR . '/includes/uwa_user_bid_won_csv.php' );
			...
			public function uwa_pro_server_cron_setup( $url = false ) {
				...
				*/
				...
				if ( @$_REQUEST['ua-auction-cron'] == 'ending-soon-sms' ) {
					...
					if(in_array('uwa_twilio_sms_addon', $addons)){
